// Generated on 2014-07-19 using generator-bones 0.0.4
'use strict';
    ...
    grunt.initConfig({
        ...
        assemble: {
            options: {
                ...
                helpers: ['<%= yeoman.src %>/templates/helpers/helper-*.js']
            },
            pages: {
                files: {
            ...
            home: {
                ...
                files: {
                    '<%= yeoman.src %>/': ['<%= yeoman.src %>/templates/pages/home/*.hbs']
                }
            },
            blog: {
                options: {
                    flatten: true,
                    layout: '<%= yeoman.src %>/templates/layouts/blog-layout.hbs',
                    partials: '<%= yeoman.src %>/templates/partials/*.hbs',
                    data: '<%= yeoman.src %>/templates/data/*.{json,yml}'
                },
